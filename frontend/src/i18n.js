...
// Import existing namespace translations
...
// Import the new business-suggestion namespace translations
  ...
  .init({
    resources: {
      en: {
        ...
        'business-suggestions': enBusinessSuggestion // Add business-suggestion namespace
      },
      hi: {
        ...
        'business-suggestions': hiBusinessSuggestion // Add business-suggestion namespace
      },
    },
    ...
    ns: [
      ...
      'featuresname', 
      'scheme-recommender',
      'business-suggestions' // Add business-suggestion to namespaces array
    ],
