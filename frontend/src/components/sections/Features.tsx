...
const Features: React.FC<FeaturesProps> = ({ loaded }) => {
  ...
  const features = [
    ...
    },
    {
      ...
      fallbackDescription: 'Create and manage hackathons, workshops, and competitions with AI assistance and one-click social media marketing.',
      icon: Calendar,
      onClick: () => navigate('/events'),
    },
    {
      titleKey: 'features.6.title',
      descriptionKey: 'features.6.description',
      fallbackTitle: 'Public Projects Showcase',
      fallbackDescription: 'Browse innovative projects created by talented individuals and teams. Find investment opportunities and success stories.',
      icon: Award,
